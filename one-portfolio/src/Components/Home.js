...
import CV from './documents/Eugenio_CV.pdf';
      ...
      <div className=" max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-center h-full ">
        <div className="flex flex-col justify-center h-full px-4">
          ...
          <div>
            ...
            <a href={CV} download className='group text-white text-xl w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-400 to-indigo-500'>
              My Resume
